        ...
        <b-row>
          ...
          >
            <div class="d-flex align-items-center justify-content-end">
              ...
              >
                <span class="text-nowrap">Add Sport</span>
              </b-button>
            </div>
          </b-col>
        </b-row>
...
export default {
  ...
  methods: {
      ...
      await this.$apollo.mutate({
        ...
        update: async cache => {
          ...
          try {
            ...
            data.sport = data.sport.filter(sport => sport.id !== item.id)
    ...
    async changeStatus(item) {
      ...
      await this.$apollo.mutate({
        mutation: gql`mutation test($id: Int, $disabled: Boolean) {
          update_sport(where: {id: {_eq: $id}}, _set: {disabled: $disabled}) {
            returning {
              disabled
              id
              name
    ...
    async getSports() {
      ...
      this.sports = result.data.sport.map(sport => ({
        id: sport.id,
